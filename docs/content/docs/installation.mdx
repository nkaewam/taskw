...
<Callout type="success">
  **Installation successful!** Taskw is ready to use. Next, try the [Quick Start Guide](/quick-start).
</Callout>
...
1. **Learn the basics** → [Quick Start Guide](/quick-start)
2. **Configure your project** → [Configuration Reference](/config/taskw-yaml)
3. **See examples** → [Example Projects](/examples)
4. **Get help** → [Troubleshooting Guide](/troubleshooting)
